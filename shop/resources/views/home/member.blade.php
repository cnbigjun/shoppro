                    ...
                    <div class="col-xs-9 main">
                        <div class="main-right">
                            <div class="right-content">
                                ...
                                <div class="zhedies">
                                    <div class="zhedie-one">
                                        <div class="zhedie zhe">
                                            <div class="head-l">个人资料</div>
                                        </div>
                                        ...
                                        <div class="information">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="split">
                                                        ...
                                                        <form action="/home/user/update" method="post">
                                                            <div class="box-body">
                                                                ...
                                                                <div>用户名：<input class="input input-left must" style="margin-left: 23px" name="username" required value="juzhiwei"> </div>
                                                                </div>
                                                            </div>
                                                            <button class="btn btn-primary save" style="margin-left: 80px;margin-top: 0;">保存</button>
                                                        </form>
                                                        
                                                        <div class="form-horizontal">
                                                            <div class="box-body">
                                                                <div>
                                                                <span>手机号：&nbsp;&nbsp;<input class="input input-left must"
                                                                                            style="background-color: #eee;"
                                                                                            value="15104243477" readonly> </span>
                                
                                                                    <span class="b-modify" onclick="openLayer('设置 - 手机号', '#mainForm')">修改手机号</span>
                                                                </div>
                                                            </div>
                                                            
                                                            <div class="box-body">
                                                                <div>
                                                                <span>邮&nbsp;&nbsp;&nbsp;&nbsp;箱：&nbsp;&nbsp;<input class="input input-left must" name="email"
                                                                                            style="background-color: #eee;margin-left: 16px;"
                                                                                            value="939335204@qq.com" readonly> </span>
                                
                                                                    <span class="b-modify" onclick="openLayer('设置 - 邮箱', '#mainForm2')">修改邮箱</span>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-xs-3">
                                                    <div class="main_top_right z">
                                                        <div class="head">
                                                            <div class="por">
                                                                <a href="javascript:;" title="">
                                                                    <img style="width: 120px;height: 120px;"
                                                                         src="__PUBLIC__/Home/images/touxiang.jpg">
                                                                </a>
                                                            </div>
                                
                                                            <form action="/home/user/update/avater" enctype="multipart/form-data" method="post">
                                                                <div id="crop-avatar">
                                                                    <input type="file" name="file" class="avater_input" onchange="uploadBtn.click()">
                                
                                                                    <button type="button" class="btn head-t">修改头像
                                                                    </button>
                                                                    <button type="submit" id="uploadBtn" class="btn head-t hide">开始上传</button>
                                                                </div>
                                                                <div style="color:#dd4b39;padding: 6px;margin-left: -12px">最佳尺寸: 120*120px</div>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <form id="mainForm" action="/home/user/update/phone" method="post" style="display: none">
                                    <div class="normalInput">
                                        <input type="text" class="form-control" name="phone_old" value="15104243477" readonly placeholder="旧手机号">
                                        <div class="clear"></div>
                                    </div>
                                    <div class="normalInput" style="margin-bottom: 20px;">
                                        <input type="text" name="phoneCode_old" placeholder="旧短信验证码">
                                        <span class="form-line"></span>
                                        <span class="getKey" onclick="sendUserSms(this)">发送验证码</span>
                                    </div>
                                    <div class="normalInput">
                                        <input type="text" name="phone" id="phone" autocomplete="false" value="" placeholder="新手机号">
                                        <div class="clear"></div>
                                    </div>
                                    <div class="normalInput" style="margin-bottom: 20px;">
                                        <input type="text" name="phoneCode" placeholder="新短信验证码">
                                        <span class="form-line"></span>
                                        <!--<span class="getKey" onclick="sendSms(this,'#phone')">发送验证码</span>-->
                                        <a href="javascript:void(0);" style="color: #474747;" id="sendVerifyCode" class="linkABlue invalidBtn getKey">发送验证码</a>
                                    </div>
                                    <button class="btn btn-primary btn-lg" type="submit" style="width: 320px;" onclick="layer.closeAll('page');">保存</button>
                                </form>
                                
                                <form id="mainForm2" action="/home/user/update/email" method="post" style="display: none">
                                    <div class="normalInput">
                                        <input type="text" class="form-control" name="email_old" value="939335204@qq.com" readonly placeholder="旧邮箱">
                                        <div class="clear"></div>
                                    </div>
                                    <div class="normalInput" style="margin-bottom: 20px;">
                                        <input type="text" name="emailCode_old" placeholder="旧邮箱验证码">
                                        <span class="form-line"></span>
                                        <span class="getKey" onclick="sendUserEmail(this)">发送验证码</span>
                                    </div>
                                    <div class="normalInput">
                                        <input type="text" name="email" id="email" autocomplete="false" value="" placeholder="新邮箱">
                                        <div class="clear"></div>
                                    </div>
                                    <div class="normalInput" style="margin-bottom: 20px;">
                                        <input type="text" name="emailCode" placeholder="新邮箱验证码">
                                        <span class="form-line"></span>
                                        <span class="getKey" onclick="sendEmail(this, '#email')">发送验证码</span>
                                    </div>
                                    <button class="btn btn-primary btn-lg" type="submit" style="width: 320px;" onclick="layer.closeAll('page');">保存</button>
                                </form>
