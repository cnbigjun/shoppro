    ...
    <div class="mzcontainer">
        ...
        <div class="topbar-right">
            <ul class="topbar-info">
                ...
                @if(!Auth::user())
                <li class="mz_login">
                    <a class="topbar-link site-login" target="_self" href="{{url('auth/login')}}">登录</a>
                </li>
                <li class="mz_login">
                    <a class="topbar-link" target="_self" href="{{url('auth/register')}}">注册</a>
                </li>
                @else
                <li class="mz_login">
                    <a class="topbar-link site-login" target="_self" href="{{url('auth/login')}}">{{Auth::user()->name}}</a>
                </li>
                <li class="mz_login">
                    <a class="topbar-link" target="_self" href="{{url('auth/logout')}}">退出</a>
                </li>
